...
<div>
  <form action="/filmServlet?action=addFilm" class="layui-form" style="display: flex;flex-direction: column;" method="post">
    ...
    <div style="margin: auto">
      <button id="add" class="layui-btn" lay-submit >添加</button>
